                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu nav nav-pills nav-stacked">
                            <li><a href="#"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>欢迎您
                                <span><security:authentication property="principal.username"/></span></a></li>
                            <li><a href="${pageContext.request.contextPath}/logout.do" class="hrms_logout"><span
